...
import org.vpac.grisu.model.dto.DtoDataLocation;
import org.vpac.grisu.model.dto.DtoDataLocations;
import org.vpac.grisu.model.dto.DtoStringList;
import org.vpac.grisu.model.dto.DtoSubmissionLocationInfo;
...
public class Gricli {
	...
	JobStagingException {
		...
		//TODO this won't work anymore. better to use the uploadInputFiles method now. This will add this property automatically.
